...
# add_copy_test("test_a", as_contiguous_array, as_strided_array, cuda0, cuda1, num_copy_elems, 0,
#               CopyParams(src_mempool_config=MEMPOOL_CONFIG_ALLOC,
#                          dst_mempool_config=MEMPOOL_CONFIG_OFF,
#                          access_dst_src=True,
